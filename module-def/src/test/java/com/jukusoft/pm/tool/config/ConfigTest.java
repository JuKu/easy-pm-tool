package com.jukusoft.pm.tool.config;
...
public class ConfigTest {
    ...
    public void testLoad () throws IOException {
        Config.load(new File("../config/test/junit-logger.cfg"));
    ...
    public void testLoadDirAsFile () throws IOException {
        Config.load(new File("../config/test/"));
    }

    @Test
    public void testLoadExampleConfig () throws IOException {
        Config.load(new File("../config/test/exampleconfig/test.example.cfg"), true);
        Config.load(new File("../config/test/exampleconfig/test.travis.cfg"), true);
    }
